...
// We need to get the instance of the LayoutInflater
            LayoutInflater inflater = (LayoutInflater) PublishRouteActivity.this
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            View layout = inflater.inflate(R.layout.activity_hurrah,
                    (ViewGroup) findViewById(R.id.popup_element));
            pwindo = new PopupWindow(layout, 900, 800, true);
            pwindo.showAtLocation(layout, Gravity.CENTER, 0, 0);

            btnClosePopup = (Button) layout.findViewById(R.id.done);
            btnClosePopup.setOnClickListener(cancel_button_click_listener);

            btnViewPopup = (Button) layout.findViewById(R.id.viewride);
            btnViewPopup.setOnClickListener(view_button_click_listener);
    ...
    private View.OnClickListener view_button_click_listener = new View.OnClickListener() {
        public void onClick(View v) {
            Intent intent = new Intent(PublishRouteActivity.this,ViewRide.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.logout:
                ...
                Intent intent = new Intent(PublishRouteActivity.this,SigninActivity.class);
                startActivity(intent);
                return true;
            default:
